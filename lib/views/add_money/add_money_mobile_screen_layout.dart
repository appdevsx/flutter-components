  ...
  _paymentGatewayWidget(BuildContext context) {
    return Column(
      children: [
        ...
        TitleHeading5Widget(
          text:
              "${Strings.limit} ${controller.limitMin.value.toStringAsFixed(2)} ${controller.baseCurrency.value} - ${controller.limitMax.value.toStringAsFixed(2)} ${controller.baseCurrency.value} ",
        ...
        Container(
          ...
          child: CustomDropDown<Currency>(
            ...
            onChanged: (value) {
              ...
              debugPrint(
                  "---------------${controller.selectWallet.value}, ${controller.selectAlias.value} ${controller.selectedCurrencyType.value}  ${controller.selectRate.value}-----------");
            },
            isExpanded: false,
