...
class AddMoneyController extends GetxController {
  ...
  ///* Stripe confirm api process start
  Future<CommonSuccessModel> addMoneyStripeConfirmProcess() async {
    ...
    await AddMoneyApiServices.addMoneyStripeConfirmApi(body: inputBody)
        .then((value) {
      _addMoneyStripeConfirmModel = value!;
      Get.to(
        () => CongratulationScreen(
          route: Routes.navigationScreen,
          subTitle: _addMoneyStripeConfirmModel.message.success.first,
