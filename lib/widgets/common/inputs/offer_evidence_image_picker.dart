...
class OfferEvidenceImagePickerWidget extends StatefulWidget {
  const OfferEvidenceImagePickerWidget({
    Key? key,
  ...
  @override
  State<OfferEvidenceImagePickerWidget> createState() =>
      _OfferEvidenceImagePickerWidgetState();
}

class _OfferEvidenceImagePickerWidgetState
    extends State<OfferEvidenceImagePickerWidget> {
